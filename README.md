...
At the same time, we are also planning to support more model service providers, such as Replicate and Perplexity, to further enrich our service provider library. If you would like AiPMChat to support your favorite service provider, feel free to join our [community discussion](https://github.com/lobehub/lobe-chat/discussions/1284).
...
- [lobe-chat-plugins][lobe-chat-plugins]: This is the plugin index for LobeChat. It accesses index.json from this repository to display a list of available plugins for AiPMChat to the user.
- [chat-plugin-template][chat-plugin-template]: This is the plugin template for AiPMChat plugin development.
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The AiPMChat Plugin SDK assists you in creating exceptional chat plugins for Lobe Chat.
