...
The above is the core implementation of the AiPMChat session API. With an understanding of these core codes, further expansion and optimization of LobeChat's AI functionality can be achieved.
