...
Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, AiPMChat supports integration with Ollama, meaning you can easily use the language models provided by Ollama to enhance your application within LobeChat.
...
```bash
docker run -d -p 3210:3210 -e OLLAMA_PROXY_URL=http://host.docker.internal:11434/v1 aipmhub/aipm-chat
```
